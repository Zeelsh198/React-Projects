...
export const Login = () => {
  ...
  const generateOTP = () => {
    if (!formState.mobilenumber || formState.mobilenumber.length !== 10) {
      return updateFormState("nbrError", "Mobile number must be exactly 10 digits.");
    }
  ...
  const checkOtp = () => {
    ...
    if (formState.enterOtp === formState.otp.toString()) {
      ...
      // Store the LoginData in local storage
      const LoginData = {
      ...
      <div className="geybg">
        <div className="login">
          ...
          <div className="role">
            ...
            <select name="role" id="role" onChange={handleRole} value={formState.role}>
